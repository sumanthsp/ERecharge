...
<body style="height: 870px">
    <form id="form1" runat="server">
        ...
        &nbsp;<table>
            <tr>
                <td class="auto-style2">ENTER MOBILE No:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:TextBox ID="txt_mob" runat="server" Height="22px" Style="margin-left: 0px" Width="163px"></asp:TextBox>
                    <br />
                    <br />
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;OPERATOR:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:DropDownList ID="dd_op" runat="server" Height="22px" Width="171px">
                    <asp:ListItem Enabled="true" Text="Select operator" Value="-1"></asp:ListItem>
                    <asp:ListItem Text="TATA DOCOMO" Value="1"></asp:ListItem>
                    <asp:ListItem Text="AIRTEL" Value="2"></asp:ListItem>
                    <asp:ListItem Text="AIRCEL" Value="2"></asp:ListItem>
                    <asp:ListItem Text="VODAFONE" Value="2"></asp:ListItem>
                    <asp:ListItem Text="IDEA" Value="2"></asp:ListItem>
                </asp:DropDownList>
                    <br />
                    <br />
                    RECHARGE TYPE:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
