<%@ Page Language="VB" AutoEventWireup="false" CodeFile="p6cpwd.aspx.vb" Inherits="Default3" %>
       ...
       <asp:Panel ID="head" runat="server">
        ...
        &nbsp;<table style="width: 1001px; height: 142px">
            <td class="auto-style3">&nbsp;&nbsp;&nbsp; MY ACCOUNT:<br />
                <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; USER NAME: 
                <asp:label ID="lab_name" runat="server" Height="22px" Style="margin-left: 0px" Width="163px"></asp:label>&nbsp;&nbsp;&nbsp;&nbsp; MOBILE NO: 
        ...
        <table>
            <tr>
                ...
                <br />
                <br />
                <td class="auto-style4">CHANGE PASSWORD:<br />
                    <br />
                    <br />
                    <br />
                    OLD PASSWORD:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                <asp:TextBox ID="txt_oldpwd" runat="server" Height="22px" Style="margin-left: 0px" Width="163px"></asp:TextBox>
                    <br />
                    <br />
                    NEW PASSWORD:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                <asp:TextBox ID="txt_newpwd" runat="server" Height="22px" Style="margin-left: 0px" Width="163px"></asp:TextBox>
                    <br />
                    <br />
                    CONFIRM PASSWORD:&nbsp;&nbsp; 
                <asp:TextBox ID="txt_copwd" runat="server" Height="22px" Style="margin-left: 0px" Width="163px"></asp:TextBox>
                    <br />
                    <br />
                    <br />
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button ID="btn_submit" runat="server" Height="35px" Text="SUBMIT" Width="110px" />
                    <br />
                    <br />
                    <br />
                    <br />
